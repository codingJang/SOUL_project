...
val_df = pd.read_csv('dataframes/val_df.csv')
...
class LSTMEnv(MultiAgentEnv):
    ...
    def __init__(self, render_mode=None):
        ...
        self.lstm = nn.LSTM()
        self.lstm.load_state_dict(torch.load('lstm_state_dict.pth'))
        self.linear = nn.Linear()
        self.linear.load_state_dict(torch.load('linear_state_dict.pth'))
        self.x = torch.load('x_save.pth')
        self.hidden = torch.load('hidden_save.pth')
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self.eco_observation = self.x.detach().numpy()
